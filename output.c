    ...
    long b; /* [0..255] */
{
    ...
    const MAX_RGB_COLOR_VALUE = 0xff;
    const COLOR_INTENSE = 0x8;
    const COLOR_RED = 0x1;      // ANSI16 "RED"
    const COLOR_GREEN = 0x2;    // ANSI16 "GREEN"
    const COLOR_BLUE = 0x4;     // ANSI16 "BLUE"
    const COLOR_GRAY = COLOR_RED|COLOR_GREEN|COLOR_BLUE;
    const COLOR_DARKGRAY = COLOR_INTENSE|0;
    const COLOR_WHITE = COLOR_INTENSE|COLOR_GRAY;
        ...
        else
        {
                 ...
                 (p_next = memchr(p_next, ESC, ob - p_next)) != NULL; )
            {
                ...
                if (p[1] == '[')  /* "ESC-[" sequence */
                {
                    ...
                    at: 2 == standout / inverse == reverse fg / bg
                    ...
                    */
                    ...
                    ESC [ 1 m        == Set bright or bold => high-intensity foreground
                    ESC [ 2 m        == UNset bright or bold (from ConEMU; Set dim from wikipedia)
                    ...
                    */
                    ...
                    while (!is_ansi_end(*p))
                    {
                        ...
                        case 23: /* italic off */
                            at &= ~2;
                            break;
                        case 27: /* normal / reset attributes */
                            at = 0;
                            break;
